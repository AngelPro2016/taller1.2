...
class Producto(models.Model):
    ...
    categotia = models.ForeignKey(Categorias, on_delete=models.RESTRICT)
...
class Cliente(models.Model):
    ...
    apellido_cliente= models.CharField(max_length=50, verbose_name='Nombre: ', unique=True, blank=False)
    edad = models.IntegerField()
    correo = models.EmailField()
    domicilio = models.TextField(max_length=200,help_text='Escribe una indicacion de tu domicilio')
